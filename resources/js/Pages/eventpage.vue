...
<section class="px-4 py-20 bg-gradient-to-r from-white to-purple-200">
  <div class="grid items-center grid-cols-1 gap-4 mx-auto max-w-7xl lg:grid-cols-2 xl:grid-cols-3">
    <div>
      <h2 class="mb-6 text-3xl font-bold md:leading-tight md:text-4xl md:mb-4">DBRFFI News & Events</h2>
        <div class="flex flex-col mb-2 space-x-0 space-y-2 sm:flex-row sm:space-x-2 sm:space-y-0">
           <p class="mt-2 dark:text-gray-400">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Porro beatae error laborum ab amet sunt recusandae? Reiciendis natus perspiciatis optio.</p>
        </div>
       </div>
    </div>
</section>
 ...
 <article class="px-4 py-24 mx-auto max-w-7xl" itemid="#" itemscope itemtype="http://schema.org/BlogPosting">
  <div class="w-full mx-auto mb-10 text-left md:w-3/4 lg:w-1/2">
    <div class="pb-6 mb-6 border-b border-gray-200">
        <span class="inline-block py-2 px-2 rounded bg-pink-50 text-pink-500 text-xs font-medium tracking-widest">UPCOMING EVENT</span>
      <h1 class="mb-3 text-3xl font-bold text-gray-900 md:leading-tight md:text-4xl" itemprop="headline" title="Rise of Tailwind - A Utility First CSS Framework">
       Lorem ipsum - A virtual event for all members
      </h1>
      <p class="text-base text-gray-500">January 18, 2021 at 4:00 PM — by Jawad Agantal</p>
    </div>
    <div class="flex items-center mb-6 space-x-2">
      <p class="text-gray-600">Share this event</p>
  ...
  <div class="w-full mx-auto prose md:w-3/4 lg:w-1/2">
    ...
    <p>Tailwind is a utility-first CSS framework, the keyword being ‘utility’. It is basically a set of classes that you can use in your HTML.</p>
    <a href="#"><p class="my-3 text-blue-400">A Utility First CSS Framework</p></a>
  </div>
</article>
      </div>
    </div>
