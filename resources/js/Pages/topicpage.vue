             ...
             <BreezeAuthenticatedLayout>
              ...
              <section class="px-4 py-20 bg-gradient-to-r from-white to-purple-200">
                <div class="grid items-center grid-cols-1 gap-4 mx-auto max-w-7xl lg:grid-cols-2 xl:grid-cols-3">
                    <div>
                    <h2 class="mb-6 text-3xl font-bold md:leading-tight md:text-4xl md:mb-4">Land Use and Property Rights</h2>
 ...
 <article class="px-4 py-24 mx-auto max-w-7xl" itemid="#" itemscope itemtype="http://schema.org/BlogPosting">
  <div class="w-full mx-auto mb-10 text-left md:w-3/4 lg:w-1/2">
    <div class="pb-6 mb-6 border-b border-gray-200">
        <span class="inline-block py-2 px-2 rounded bg-pink-50 text-purple-500 text-xs font-medium tracking-widest">Land Use and Property Rights</span>
      ...
      <p class="text-base text-gray-500">January 18, 2021 — Written by Jawad Agantal</p>
    </div>
    <div class="flex items-center mb-6 space-x-2">
      <p class="text-gray-600">Share this — </p>
    ...
    <img src="/images/buildingbg.jpg" class="object-cover w-full h-64 bg-center rounded" alt="Kutty" />
  </div>
